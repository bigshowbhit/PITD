...
public class GamePanel extends JPanel implements Runnable {
    ...
    public GamePanel() {
        gameTimer = new Timer(12); // 60 seconds countdown
        timeRemaining = 12; // Set the initial time remaining to 60 seconds
    ...
    public void paintComponent(Graphics g) {
        ...
        g2.drawString("Time Remaining: " + timeRemaining + "s", 40, 40);
